...
class PaymentMethodFragment : Fragment(), ConnectivityReceiver.ConnectivityReceiverListener {
    ...
    override fun onNetworkConnectionChanged(isConnected: Boolean) {
        ...
        if (!isConnected) {
            ...
            try {
                mSnackBar = Snackbar
                        .make(owner_payment, getString(R.string.alert_no_internet), Snackbar.LENGTH_INDEFINITE)
