 ...
 * Use the [VideoInterviewListFragment.newInstance] factory method to
...
class VideoInterviewListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_video_interview_list, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment VideoInterviewListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                VideoInterviewListFragment().apply {
