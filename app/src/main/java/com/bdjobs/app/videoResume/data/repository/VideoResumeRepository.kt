...
class VideoResumeRepository(private val application: Application) {
    ...
    fun getAllQuestionsFromDB() : List<Question> {
        return listOf(
                ...
                Question("3","Discuss about your Job Experience (if any) or Skills.","00:60", isNew = false, isSubmitted = false),
    ...
    fun getAllQuestionsFromDBInBn() : List<Question> {
        return listOf(
            ...
            Question("৩","আপনার চাকরির অভিজ্ঞতা(যদি থাকে) অথবা দক্ষতা সম্পর্কে বলুন।","০০:৬০", isNew = false, isSubmitted = false),
