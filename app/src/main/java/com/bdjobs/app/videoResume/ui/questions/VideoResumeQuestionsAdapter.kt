...
class VideoResumeQuestionsAdapter(val context: Context, val clickListener: ClickListener) :
    ...
    companion object DiffUtilCallback : DiffUtil.ItemCallback<VideoResumeQuestionList.Data>() {
        override fun areItemsTheSame(oldItem: VideoResumeQuestionList.Data, newItem: VideoResumeQuestionList.Data): Boolean {
            return oldItem == newItem
        }

        override fun areContentsTheSame(oldItem: VideoResumeQuestionList.Data, newItem: VideoResumeQuestionList.Data): Boolean {
            return oldItem.questionId == newItem.questionId
        }
    }

    class QuestionViewHolder(private var binding: ItemVideoResumeQuestionBinding) :
