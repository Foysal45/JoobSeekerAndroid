...
class GuidelineFragment : Fragment() {
    ...
    private val stepsInBangla = listOf<String>(
            ...
            "প্রোফাইলে ভিডিও রিজিউমি যুক্ত করুন"
    )
    ...
    private val tipsInBangla = listOf(
            ...
            "যে সফটওয়্যার দিয়ে ভিডিও রিজিউমি রেকর্ড করবেন সেই সফটওয়্যার সম্পর্কে জানুন",
            ...
            "কোন ধরণের নিয়োগকর্তা আপনার ভিডিও রিজিউমি ভিউ করতে পারে সেই সম্পর্কে জানুন"
    )
    ...
    private val benefitsInBangla = listOf(
            "ইন্টারভিউতে দক্ষতার নিজের সাথে পার্সোনালিটি তুলে ধরুন",
            "স্বল্প সময়ে উত্তর প্রাসঙ্গিক রেখে আপনার স্কিলগুলো তুলে ধরুন",
            "আপনার টেকনোলজি বেসড স্কিলগুলো তুলে ধরুন",
            "টেকনোলজি ব্যবহার করে আই ক্যাচিং কনটেন্ট তৈরী করুন",
            "যে সফটওয়্যার দিয়ে ভিডিও রিজিউমি রেকর্ড করবেন সেই সফটওয়্যার সম্পর্কে জানুন",
            "নিজেকে উপস্থাপনমূলক করে তুলুন",
            "আপনি কেন ডিফারেন্ট বা কিভাবে একটা কোম্পানির জন্য ভ্যালুয়েবল এসেট হতে পারেন তা সাবলীল ভাষায় উপস্থাপন করুন"
    )
