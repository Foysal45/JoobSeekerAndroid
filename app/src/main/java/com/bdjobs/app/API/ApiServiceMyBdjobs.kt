...
interface ApiServiceMyBdjobs {
    ...
    fun getLogin2UserDetails(
        @Field("username") username: String? = "",
        @Field("appId") appId: String? = Constants.APP_ID
    ): Call<Login2UserModel>
...
//    @POST("apps_updateBlueCv_testp.asp")
    ...
    suspend fun updateSMSSettings(
        ...
        @Field("isMatchedJobEnable") isMatchedJobEnable: String?,
        @Field("isFollowedEmployerEnable") isFollowedEmployerEnable: String?,
        @Field("isFavSearchEnable") isFavSearchEnable: Int?
    ): CommonResponse
